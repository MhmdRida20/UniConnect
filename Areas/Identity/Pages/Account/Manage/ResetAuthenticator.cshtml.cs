    ...
    public class ResetAuthenticatorModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            await _auditLog.LogAsync(
                "TwoFactorAuthenticatorReset",
                userId: user.Id, universityCode: user.UniversityCode,
                entityType: "User", entityId: user.Id,
                details: "Reset the authenticator key; two-factor is off until a new app is verified.");

            await _signInManager.RefreshSignInAsync(user);
            StatusMessage = "Your authenticator key has been reset. Set up your app again with the new key below.";
